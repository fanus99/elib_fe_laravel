            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>123 hari</td>
                                            <td>
                                                <a href="{{route('update_eksemplarbuku')}}" class="btn btn-warning btn-sm">update</a>
                        ...
                        <br>
                        <a class="btn btn-success btn-sm btn-kiri" href="{{route('create_eksemplarbuku')}}" role="button"><h3>+</h3></i></a>
                    </div>
                </main>
