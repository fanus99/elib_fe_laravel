            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>aisya</td>
                                            <td>
                                                <a href="{{route('create_bukustok')}}" class="btn btn-warning btn-sm">update</a>
                        ...
                        <br>
                        <a class="btn btn-success btn-sm btn-kiri" href="{{route('update_bukustok')}}" role="button"><h3>+</h3></i></a>
                    </div>
                </main>
